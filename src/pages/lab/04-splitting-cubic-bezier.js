...
export default memo(function () {
  return <>
    <h1 className="work-name">Splitting a cubic Bézier curve</h1>
    <div className="blob">
      <p>
      ...
      <button className={button} type="button" style={{maxWidth: '250px'}}>
...
console.log({ transitionTimingFunction: `cubic-bezier(${cbPts[0]}, ${cbPts[1]}, ${cbPts[2]}, ${cbPts[3]})` })
