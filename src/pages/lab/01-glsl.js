...
export default memo(function() {
  return <>
    ...
    <p>Note how some uniforms are provided for you by default, while you're easily able to add your own, by calling <code>glsl.addVariable()</code></p>
    <p>Still very much a WIP, and here's my to-do list:</p>
    <ul>
